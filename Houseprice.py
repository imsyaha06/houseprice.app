...
# longitude = st.number_input("📍 Longitude", value=data['longitude'].mean(), step=0.01, format="%.2f")
# latitude = st.number_input("📍 Latitude", value=data['latitude'].mean(), step=0.01, format="%.2f")
# housing_median_age = st.number_input("🏠 Housing Median Age", value=data['housing_median_age'].mean(), step=1)
# total_rooms = st.number_input("🛏️ Total Rooms", value=data['total_rooms'].mean(), step=1)
# total_bedrooms = st.number_input("🛌 Total Bedrooms", value=data['total_bedrooms'].mean(), step=1)
# population = st.number_input("👥 Population", value=data['population'].mean(), step=1)
# households = st.number_input("🏘️ Households", value=data['households'].mean(), step=1)
# median_income = st.number_input("💵 Median Income", value=data['median_income'].mean(), step=0.01, format="%.2f")
